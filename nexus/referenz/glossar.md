...
**Delivery Action** - Eine automatische Aktion, die nach einer erfolgreichen Bestellung ausgeführt wird, z.B. Datei-Download freischalten, E-Mail senden oder Zugriff auf einen Kursbereich gewähren.
...
**Handlebars** - Die Template-Engine, die Nexus für E-Mail Templates verwendet. Variablen werden mit doppelten geschweiften Klammern eingefügt: `{{variable}}`.
...
**Template Variable** - Ein Platzhalter in E-Mail Templates, der beim Versand durch einen echten Wert ersetzt wird. Beispiel: `{{vorname}}` wird zu "Max".
