...
Claude Code hat drei Erweiterungsmechanismen. Sie sind kein Muss am Anfang, aber sobald du oefter mit dem Tool arbeitest, lohnt sich der Blick.

## Skills

Wiederverwendbare Anweisungen fuer ein bestimmtes Vorgehen. Beispiel: "Commit-Skill" - wenn du "/commit" aufrufst, liest Claude die Aenderungen und erstellt einen sauberen Commit.
...
Spezialisierte Agents, die Claude selbst aufruft fuer bestimmte Aufgaben. Beispiel: Code-Review-Agent, der einen frischen Blick auf Aenderungen wirft.
...
- **Subagents:** sobald du einen zweiten, unabhaengigen Blick auf ein Ergebnis willst

TODO: Beispiele fuer "Ah, dafuer braucht man Skills/Hooks/Subagents".
