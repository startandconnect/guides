...
order: 3
excerpt: Ein konkreter Pfad von Installation zu erstem echten Ergebnis
---
...
- `claude` startet
- In einem leeren Ordner: `claude`, dann "Was siehst du in diesem Verzeichnis?"
- Erste Antwort abwarten, lesen, verstehen

TODO: Screenshots, typische Reaktionen.
...
- "Schreib mir ein Python-Skript, das alle PDF-Dateien in diesem Ordner umbenennt nach Schema XYZ."

TODO: Konkrete Beispiele durchspielen, erwartete Zwischenschritte zeigen.
